...
if __name__ == "__main__":
    ...
    parser.add_argument("--identity", type=bool, default=False)  # New: Add identity flag
    parser.add_argument("--label_file", type=str, default="identity_labels.txt")  # New: Identity label file
    ...
    with lmdb.open(args.out, map_size=1024 ** 4, readahead=False) as env:
        if args.identity:
            prepare_identity(env, imgset, args.n_worker, sizes=sizes, resample=resample, label_file=args.label_file)
        else:
